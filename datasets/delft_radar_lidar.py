...
from datasets.data_classes import RadarCloud, PointCloud, Box
...
class DelftRadarLidarDataset(base_dataset.BaseDataset):
    ...
    def _get_frame_from_anno_radar_lidar(self, anno):
        frame = anno['frame']
        box = self.get_radarbox(anno,frame)
        center = box[:3]
        dx,dy,dz = box[3:6]
